"""
Django settings for microblog_project project.
...
ALLOWED_HOSTS = ["vibetext.onrender.com"]
...
ROOT_URLCONF = 'microblog_project.urls'
...
WSGI_APPLICATION = 'microblog_project.wsgi.application'
