# Generated by Django 5.0.3 on 2026-01-13 20:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0003_alter_communitypostlike_unique_together_and_more'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        # DB-safe column additions (Postgres): add if not exists
        migrations.RunSQL(
            sql=(
            ...
            reverse_sql=(
                "ALTER TABLE core_commentlike DROP COLUMN IF EXISTS created_at;"
            ),
        ),
        migrations.RunSQL(
            sql=(
            ...
            reverse_sql=(
                "ALTER TABLE core_communitypostlike DROP COLUMN IF EXISTS created_at;"
            ),
        ),
        migrations.RunSQL(
            sql=(
            ...
            reverse_sql=(
                "ALTER TABLE core_profile DROP COLUMN IF EXISTS action_points;"
            ),
        ),
        migrations.RunSQL(
            sql=(
            ...
            reverse_sql=(
                "ALTER TABLE core_profile DROP COLUMN IF EXISTS badge;"
            ),
        ),
        migrations.RunSQL(
            sql=(
            ...
            reverse_sql=(
                "ALTER TABLE core_profile DROP COLUMN IF EXISTS last_recalc;"
            ),
        ),
        migrations.RunSQL(
            sql=(
            ...
            reverse_sql=(
                "ALTER TABLE core_profile DROP COLUMN IF EXISTS score;"
            ),
        ),

        # Remaining safe AlterField operations
